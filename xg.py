...
file_path = '/Users/triahavijayekkumaran/Downloads/dataremnums_cleaned_customsw_stemmed.csv'
...
# Train a Gradient Boosting Machine (GBM) using XGBoost
clf = XGBClassifier(random_state=42, scale_pos_weight=1)
